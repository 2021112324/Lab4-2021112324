...
public class L2021112324_7_Test {
    ...
    public void testSmallestStringWithSwaps() throws Exception {
        ...
        Assert.assertEquals("a",testSolution7.smallestStringWithSwaps(test1_s,test1_p));

        String test2_s = "abcd";
        List<List<Integer>> test2_p = new ArrayList<>();
        List<Integer> test2_p_1 = new ArrayList<>();
        Assert.assertEquals("abcd",testSolution7.smallestStringWithSwaps(test2_s,test2_p));
